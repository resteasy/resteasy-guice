...
Want to contribute to the RESTEasy Guice? We try to make it easy, and all contributions, even the smaller ones,
...
All original contributions to RESTEasy Guice are licensed under the
...
This project uses https://github.com/resteasy/resteasy-guice/issues[GitHub Issues] for filing issues.
...
RESTEasy Guice has a strictly enforced code style. Code formatting is done by the Eclipse code formatter, using the config files
